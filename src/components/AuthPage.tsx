      ...
      <div className="hidden lg:flex w-[55%] relative items-center justify-center overflow-hidden bg-[#0a0a0f] border-l border-white/[0.02]">
         ...
         <div className="relative w-full max-w-2xl aspect-square z-10 flex items-center justify-center">
            ...
            >
               ...
               <div className="p-6">
                 {/* Generation Loader Simulation */}
                 <div className="w-full aspect-video rounded-xl overflow-hidden relative mb-4 border border-white/5 bg-black/50 p-2 flex gap-2">
                    <img src="https://images.unsplash.com/photo-1542291026-7eec264c27ff?q=80&w=700&auto=format&fit=crop" className="w-1/2 h-full object-cover rounded-lg opacity-80" />
                    <img src="https://images.unsplash.com/photo-1616423640778-28ce795ec2e5?q=80&w=700&auto=format&fit=crop" className="w-1/2 h-full object-cover rounded-lg opacity-80" />
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent flex items-end p-4">
                       <div className="w-full flex items-center gap-3">
                         ...
                         <div className="text-xs font-bold text-white">Gerando 12 Variações...</div>
                       </div>
                    </div>
                 </div>
                 ...
                 <div className="grid grid-cols-4 gap-2">
                   {[1,2,3,4].map(i => (
                     <div key={i} className="aspect-square bg-white/[0.03] rounded-lg border border-white/5 flex items-center justify-center p-2">
                        <div className="w-full h-full bg-gradient-to-br from-white/10 to-transparent rounded opacity-30"></div>
                     </div>
                   ))}
                 </div>
               </div>
