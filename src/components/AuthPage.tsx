      ...
      <div className="hidden lg:flex w-[55%] relative items-center justify-center overflow-hidden bg-[#0a0a0f] border-l border-white/[0.02]">
         ...
         <div className="relative w-full max-w-2xl aspect-square z-10 flex items-center justify-center">
            ...
            >
               ...
               <div className="p-6">
                 {/* Generation Loader Simulation / Platform Demo */}
                 <div className="w-full aspect-video rounded-xl overflow-hidden relative mb-4 border border-white/5 bg-black/50 shadow-2xl">
                    <video 
                 ...
                 <div className="grid grid-cols-4 gap-2">
                   {[1,2,3,4].map(i => (
                     <div key={i} className="aspect-square bg-white/[0.03] rounded-lg border border-white/5 flex items-center justify-center p-1.5 overflow-hidden group/thumb hover:border-[#FFB800]/30 transition-colors">
                        <img src={`/images/auth/auth_preview_${i}.jpg`} className="w-full h-full object-cover rounded shadow-lg opacity-60 group-hover/thumb:opacity-100 group-hover/thumb:scale-110 transition-all duration-500" alt={`UGC Preview ${i}`} />
                     </div>
                   ))}
                 </div>
               </div>
