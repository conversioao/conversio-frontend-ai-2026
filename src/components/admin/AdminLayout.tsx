...
import { LayoutDashboard, Users, CreditCard, Settings, LogOut, Shield, ChevronRight, BarChart2, ShieldAlert, Megaphone, History, Box, Layers, ShieldCheck, TrendingUp } from 'lucide-react';
        ...
        <nav className="flex-1 p-6 space-y-3">
           ...
           {navItems.map((item) => (
             <button
               ...
               className={`w-full flex items-center gap-3 px-5 py-4 rounded-2xl transition-all font-bold text-sm group ${
                 currentPage === item.id 
