...
import { Users, Activity, CreditCard, Layers, Zap, Clock, TrendingUp, Sparkles, BarChart3, PieChart as PieChartIcon } from 'lucide-react';
import { 
...
export function AdminDashboard() {
  ...
  const fetchStats = async () => {
    try {
      ...
      const res = await apiFetch(`http://localhost:3003/api/admin/stats?adminId=${user.id}`);
