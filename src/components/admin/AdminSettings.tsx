    ...
    try {
      ...
      if (data.success) {
        ...
        setModal({
          ...
          message: data.message || 'Falha ao salvar as configurações no servidor.',
          type: 'error'
        });
      }
    } catch (err) {
  ...
  return (
    ...
    <div className="space-y-8 pb-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
         ...
         {/* AI Config Section */}
         <ConfigCard title="Agente IA (Especialista)" icon={<Bot size={24} />} badge="OpenAI API" section="ai_agent">
