...
const CORES = [
  {
    ...
    generates: 'Cenas do quotidiano, pessoas reais em Luanda, momentos de descoberta, unboxing e recomendação direta com alta carga de autenticidade.',
    idealFor: ['Produtos de consumo', 'Moda e Beleza', 'Restaurantes', 'Serviços locais'],
  },
  {
    id: 'brand-visual',
    code: 'CV-02',
    name: 'BrandVisual Pro',
    category: 'Banner Visual Profissional',
    type: 'universal' as const,
    icon: Star,
    gradient: 'from-blue-950 via-blue-800 to-violet-700',
    barColor: 'from-blue-400 to-violet-500',
    glowColor: 'rgba(99,102,241,0.2)',
    badgeColor: 'bg-blue-500/20 text-blue-300 border-blue-500/30',
    for: 'Marcas que buscam uma estética premium e profissional para fortalecer o seu posicionamento no mercado.',
    generates: 'Composições elegantes, minimalismo poderoso, gradientes vibrantes, iluminação editorial e foco total na qualidade visual da marca.',
    idealFor: ['Lançamentos de marca', 'Produtos premium', 'Tecnologia', 'Editorial de moda'],
  },
  {
    id: 'banner-flyer',
    code: 'CV-03',
    name: 'Banner e Flyer',
    category: 'Marketing de Impacto',
    type: 'universal' as const,
    icon: Layers,
    ...
    for: 'Campanhas promocionais rápidas, eventos e comunicação direta de vendas.',
    generates: 'Designs de alta energia para promoções, lançamentos rápidos, depoimentos integrados e informação clara de serviços ou datas especiais.',
    idealFor: ['Promoções Flash', 'Eventos', 'Cardápios e Preçários', 'Comunicados'],
  },
];
    ...
    <div className="relative z-10 text-white min-h-screen flex flex-col">
      ...
      <div className="relative z-10 container mx-auto px-6 max-w-7xl mt-16 flex-grow">
        ...
        <section className="pt-32 pb-20 text-center">
          ...
          >
            Os únicos 3 agentes que precisas para dominar o mercado — treinados especificamente para gerar anúncios de alta conversão.
          </motion.p>
          ...
          >
            <div className="text-center">
              <div className="text-2xl font-black text-[#FFB800]">3</div>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <h2 className="text-4xl md:text-6xl font-black tracking-tighter mb-6 leading-tight">
                Começa com o <br />
                <span className="text-[#FFB800]">CV-02 BrandVis Pro</span>
              </h2>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <motion.button
                  onClick={() => handleUseCore(CORES.find(c => c.code === 'CV-02') || CORES[1])}
