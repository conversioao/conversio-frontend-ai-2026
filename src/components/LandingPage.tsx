...
export function LandingPage({ onEnter, onNavigate }: LandingPageProps) {
  ...
  const fetchCreditPackages = async () => {
    try {
      ...
      console.error('[LandingPage] Failed to fetch credit packages:', e);
    }
  };
        ...
        <div className="absolute inset-0 pointer-events-none flex items-center justify-center z-0 hidden lg:flex">
           ...
           >
              <video 
                ...
                loop 
                playsInline 
                className="w-full h-full object-cover rounded-2xl opacity-100 transition-all duration-1000" 
                onError={(e) => console.error('[Hero Video] Erro ao carregar /videos/ugc.mp4:', e)}
                onCanPlay={() => console.log('[Hero Video] Pronto para reproduzir.')}
              />
          ...
          <AnimatePresence mode="wait">
            {activeTab === 'ugc' ? (
              <motion.div key="ugc" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="flex justify-center gap-6 flex-wrap">
                 <UgcVideoCard src="/videos/ugc_hero.mp4" title="Esse produto mudou a minha rotina!" creator="alimo_angola" isVideo />
              ...
              <div className="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div className="order-1 lg:order-2">
                   <BentoCard className="!p-4 bg-surface/30 backdrop-blur-xl border-border-subtle/50 relative overflow-hidden group">
                      <video 
                        src="/videos/comparacao.mp4" 
                        autoPlay 
                        muted 
                        loop 
                        playsInline 
                        className="absolute inset-0 w-full h-full object-cover opacity-20 pointer-events-none group-hover:opacity-40 transition-opacity duration-1000"
                      />
                ...
                <div className="hidden lg:block">
                   <BentoCard className="!p-4 bg-surface/30 backdrop-blur-xl border-border-subtle/50 relative overflow-hidden group">
                      <video 
                        ...
                        loop 
                        playsInline 
                        className="absolute inset-0 w-full h-full object-cover opacity-10 pointer-events-none group-hover:opacity-30 transition-opacity duration-1000"
                      />
                      <ComparisonPlaceholder 
                        leftLabel="Foto do Produto" 
