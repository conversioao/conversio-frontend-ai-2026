        ...
        <section className="bg-surface/40 backdrop-blur-3xl border border-white/5 rounded-[2.5rem] p-10 shadow-2xl relative overflow-hidden group">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
             <div className="flex items-center gap-4">
               ...
               <div>
                  <h2 className="text-xl font-black text-white uppercase italic tracking-tighter">Identidade Visual (Alpha)</h2>
                  <p className="text-[10px] text-text-tertiary font-bold uppercase tracking-widest mt-1">Marca d'água automática</p>
               </div>
             </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
             <div 
               className={`relative h-48 rounded-3xl border-2 border-dashed transition-all cursor-pointer flex flex-col items-center justify-center overflow-hidden group/logo ${brandLogoUrl ? 'border-emerald-500/30' : 'border-white/10 hover:border-[#FFB800]/50 hover:bg-white/5'}`}
             ...
             >
               {uploadingLogo ? (
                 ...
                 <>
                   <img src={brandLogoUrl} alt="Logo" className="max-h-32 max-w-[80%] object-contain drop-shadow-2xl brightness-110" />
                   <div className="absolute inset-0 bg-black/60 opacity-0 group-hover/logo:opacity-100 transition-opacity flex items-center justify-center backdrop-blur-sm">
                      <div className="flex items-center gap-3 px-6 py-3 bg-[#FFB800] text-black font-black uppercase text-xs rounded-full shadow-2xl">
                 ...
                 <div className="text-center group-hover/logo:scale-110 transition-transform">
                   <Upload size={40} className="mx-auto text-text-tertiary mb-4 group-hover/logo:text-[#FFB800] transition-colors" />
                   <p className="text-sm font-bold text-white uppercase tracking-tighter">Carregar logo da marca</p>
                   <p className="text-[10px] font-black text-text-tertiary mt-1">PNG Transparente • Máx 2MB</p>
                 </div>
               )}
             ...
             <div className="flex flex-col justify-center space-y-4">
                <div className="p-5 bg-white/5 rounded-2xl border border-white/5">
                   <p className="text-xs text-text-secondary leading-relaxed">
                      O logótipo carregado será injetado como <span className="text-white font-bold tracking-tight">BRAND WATERMARK</span> em todas as suas gerações rápidas ou exportações do Editor Pro. 
                      <span className="block mt-2 text-[10px] font-black text-[#FFB800] uppercase italic">Aumente sua autoridade visual automaticamente.</span>
                   </p>
                </div>
                {brandLogoUrl && (
                  <button onClick={() => setBrandLogoUrl('')} className="text-[10px] font-black text-red-500 uppercase tracking-widest text-left pl-2 hover:underline">Remover Logotipo</button>
                )}
             </div>
          </div>
        </section>
