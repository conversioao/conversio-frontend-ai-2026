      ...
      >
        ...
        <div className="w-full lg:w-[420px] p-8 flex flex-col gap-6 overflow-y-auto bg-[#0F0F0F] border-l border-white/5">
          <div className="flex flex-col gap-6">
            <div>
              <h3 className="text-[10px] font-black text-white/40 uppercase tracking-[0.2em] mb-3">PROMPT</h3>
              <p className="text-white/70 text-sm leading-relaxed italic font-light">"{item.prompt}"</p>
            </div>

            <div>
              <h3 className="text-[10px] font-black text-[#FFB800] uppercase tracking-[0.2em] mb-3">LEGENDA GERADA</h3>
              <div className="bg-white/5 rounded-2xl p-5 border border-white/5">
                 <p className="text-white/90 text-[13px] leading-relaxed mb-4 whitespace-pre-wrap">
                    {item.copy || 'Crie uma legenda para esta imagem.'}
                 </p>
                 <p className="text-[#FFB800] text-xs font-mono leading-relaxed opacity-80">
                    {item.hashtags || ''}
                 </p>
              </div>
            </div>
