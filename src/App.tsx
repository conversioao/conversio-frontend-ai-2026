  ...
  const fetchRecent = async () => {
    ...
    try {
      const [resMedia, resAudio] = await Promise.all([
        ...
        apiFetch(`/generations?userId=${user.id}&limit=10&excludeTypes=image,video,avatar`)
      ]);
